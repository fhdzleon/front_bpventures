...
export default function SecuritySettings() {
  ...
  return (
    <div className="flex  max-w-6xl mx-auto justify-center">
      <div className=" min-w-2xl p-6  bg-white shadow-xl border self-center border-gray-200 rounded-lg mb-5 mt-6  md:grid md:grid-cols-2  ">
        <section className="col-span-1">
          ...
          <div className="mb-6">
            <p className="font-futura text-gray-700 mb-4">
              ...
              aumentar la seguridad de tu cuenta. Con 2FA, necesitarás un código
              de autenticación además de tu contraseña.
            </p>
            <p className="font-futura text-gray-700 mb-4">
              En lugar de esperar la llegada de mensajes de texto, obtén códigos
              de verificación desde una app de autenticación. Funciona incluso
              si el teléfono está sin conexión.
            </p>
            <p className="font-futura text-gray-700 mb-4">
              Para configurar 2FA, primero genera un código QR escaneable con
              una aplicación de autenticación y luego, si necesitas el código
              secreto para configuraciones manuales, elige la opción
              correspondiente.
            </p>
          </div>
